...
import { Container, Title, Text, ContainerCards } from "../components/style";
...
const Home = () => (
  <>
    ...
    />
    <Container>
      <Title fontSize="2rem" marginLeft="0" marginBottom="0">
        Inovação para o seu dia a dia
      </Title>
      <Text fontSize="1rem" marginLeft="0" marginBottom="0">
